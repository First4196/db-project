CREATE TABLE IF NOT EXISTS exam(
	...
	start_time TIME,
	finish_time TIME,
    CONSTRAINT exam_pk PRIMARY KEY (course_id,course_year,course_semester,room_no,building_id,faculty_id,exam_name),
    ...
    CONSTRAINT exam_fk2 FOREIGN KEY (room_no,building_id,faculty_id) REFERENCES room(room_no,building_id,faculty_id)
);
